...
async function createPackage() {
  ...
  plop.setGenerator("component", {
    ...
    actions(answers: any) {
      ...
      const { componentName, description, useTheme, useI18n, useInverse } = answers as Answers

      actions.push({
        type: "addMany",
        templateFiles: "component-pkg/**",
        destination: "../packages/react-magma-dom/src/components/{{capitalize componentName}}",
        base: "component-pkg/",
