...
export const paragraphLargeStyles = props => css`
  ...
  css`
    font-size: var(--typographyExpressiveVisualStyles-bodyLarge-mobile-fontSize);
    line-height: var(--typographyExpressiveVisualStyles-bodyLarge-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small) {
      font-size: var(--typographyExpressiveVisualStyles-bodyLarge-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-bodyLarge-desktop-lineHeight);
    }
  `};
`;
...
export const headingXLargeStyles = props => css`
  ...
  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-headingXLarge-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-headingXLarge-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-headingXLarge-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-headingXLarge-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-headingXLarge-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-headingXLarge-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-headingXLarge-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-headingXLarge-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-headingXLarge-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-headingXLarge-desktop-lineHeight);
    }
  `};
`;
...
export const headingLargeStyles = props => css`
  ...
  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-headingLarge-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-headingLarge-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-headingLarge-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-headingLarge-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-headingLarge-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-headingLarge-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-headingLarge-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-headingLarge-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-headingLarge-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-headingLarge-desktop-lineHeight);
    }
  `};
`;
...
export const headingMediumStyles = props => css`
  ...
  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-headingMedium-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-headingMedium-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-headingMedium-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-headingMedium-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-headingMedium-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-headingMedium-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-headingMedium-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-headingMedium-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-headingMedium-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-headingMedium-desktop-lineHeight);
    }
  `};
`;
...
export const headingSmallStyles = props => css`
  ...
  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-headingSmall-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-headingSmall-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-headingSmall-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-headingSmall-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-headingSmall-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-headingSmall-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-headingSmall-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-headingSmall-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-headingSmall-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-headingSmall-desktop-lineHeight);
    }
  `};
`;
...
export const headingXSmallStyles = props => css`
  ...
  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-headingXSmall-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-headingXSmall-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-headingXSmall-mobile-lineHeight);

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-headingXSmall-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-headingXSmall-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-headingXSmall-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-headingXSmall-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-headingXSmall-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-headingXSmall-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-headingXSmall-desktop-lineHeight);
    }
  `};
`;
...
export const heading2XSmallStyles = props => css`
  ...
  @media (min-width: var(--breakpoints-small)){
    ...
    line-height: var(--typographyVisualStyles-heading2XSmall-desktop-lineHeight);
  }

  ${props.contextVariant === 'expressive' &&
  css`
    font-size: var(--typographyExpressiveVisualStyles-heading2XSmall-mobile-fontSize);
    font-weight: var(--typographyExpressiveVisualStyles-heading2XSmall-fontWeight);
    line-height: var(--typographyExpressiveVisualStyles-heading2XSmall-mobile-lineHeight);
    text-transform: none;

    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyExpressiveVisualStyles-heading2XSmall-desktop-fontSize);
      line-height: var(--typographyExpressiveVisualStyles-heading2XSmall-desktop-lineHeight);
    }
  `};

  ${props.contextVariant === 'narrative' &&
  css`
    font-size: var(--typographyNarrativeVisualStyles-heading2XSmall-mobile-fontSize);
    font-weight: var(--typographyNarrativeVisualStyles-heading2XSmall-fontWeight);
    line-height: var(--typographyNarrativeVisualStyles-heading2XSmall-mobile-lineHeight);
    @media (min-width: var(--breakpoints-small)){
      font-size: var(--typographyNarrativeVisualStyles-heading2XSmall-desktop-fontSize);
      line-height: var(--typographyNarrativeVisualStyles-heading2XSmall-desktop-lineHeight);
    }
  `};
`;
