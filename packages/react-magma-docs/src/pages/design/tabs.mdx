...
<figure>
    ...
    <figcaption>
      <p>
        Icons and text labels can be used together to help communicate what the content is.
      </p>
    </figcaption>
</figure>
...
<figure>
    ...
    <figcaption>
      <p>
        Icons can be stacked on top of the label which saves horizontal space, but also increases the vertical footprint.
      </p>
    </figcaption>
</figure>
