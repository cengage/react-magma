...
<DocsHeading to="/api/modal/" type="code">Modals</DocsHeading>
...
Dialogs are purposefully interruptive, so they should be used responsibly.
...
<Button>Launch large modal</Button>
