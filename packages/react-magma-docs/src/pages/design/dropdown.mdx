...
<figure>
  <img
    ...
    alt="Simple example of dropdown button and menu"
  />
</figure>
    ...
    <div class="col col-1">
      <figure>
        <img
          ...
          alt="Illustration showing the anatomy of a text list menu"
        />
        <figcaption>
          <p>
            There is 5px of space above the first item in the dropdown, and
            below the last item. There is also 5px of space above and below the
            divider.
          </p>
        </figcaption>
      </figure>
    ...
    <div class="col col-1">
      <figure>
        <img
          ...
          alt="Illustration showing the anatomy of an icon and text list menu"
        />
      </figure>
    </div>
    <div class="col col-2">
    ...
    <div class="col col-1">
      <figure>
        <img
          ...
          alt="Illustration showing the anatomy of a selection state list menu"
        />
      </figure>
    </div>
    <div class="col col-2">
    ...
    <div class="col col-1">
      <figure>
        <img
          ...
          alt="Illustration showing dropdown menu groups"
        />
      </figure>
    </div>
...
<figure>
  ...
  <figcaption>
    <p>
      Dropdowns can be positioned above the tigger element. If using a button,
