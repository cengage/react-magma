...
The dotted outline is 2px, and the color is #D75800 (\$focus). Both of these properties help ensure the outline is visible on both light and dark backgrounds.
