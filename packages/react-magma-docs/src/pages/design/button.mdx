...
The dotted outline is 2px thick, and the color is #D75800 ($focus). Both of these properties help ensure the outline is visible on a light background.  The color changes to white for optimal visibility on dark backgrounds.
