...
The dotted outline is 2px thick with at least a 4px offset, and the color is #027EE1 ($focus). These properties ensure the outline is visible on a light background.  The color changes to white for optimal visibility on dark backgrounds.
