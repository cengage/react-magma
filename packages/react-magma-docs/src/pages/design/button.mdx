...
<Button color="primary" variant="link">Text Button</Button>

### Outlined Button (medium emphasis)
Outlined buttons are used for more emphasis than text buttons due to the stroke.
<Button color="primary" variant="outline">Outlined Button</Button>
    ...
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          ...
          <p>Don’t wrap text. For maximum legibility and recognition as a button, a text label should never wrap to multiple lines.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Text labels can be written in title case if all efforts to make the label less than three words have been exhausted, or if the button simply won't fit in the space without making it smaller.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col">
