...
<DocsHeading to="/api/tooltip/" type="code">Tooltips</DocsHeading>
  ...
  <div class="row">
    <div class="col">
      <figure>
        ...
        <figcaption>
          <p>Tooltips can be positioned below, above, to the right of, or to the left of the element they are associated with.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Choose a tooltip position that will ensure it never gets cut off.</p>
        </figcaption>
      </figure>
    </div>
  </div>
