...
Many actions happen quickly, such as saving updates, submitting a form, or loading small amounts of data.  But there's still typically a delay between the user clicking an action and the action itself completing.
