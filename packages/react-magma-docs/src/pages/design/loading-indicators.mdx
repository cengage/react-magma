...
### Relevant
Loading indicators should have a clear and helpful relationship to the content or task they represent. They are never simply decorative.  This will inspire confidence that the application isn't frozen or not working.

### Clear
Loading indicators look and animate in ways that reflect the status of a process.  We keep the component intentionally simple so the user can quickly understand what is being communicated.
...
<figure>
  ...
  <figcaption>
    <p>In this example, testing shows that it always takes at least 15 seconds to load, and we can track the progress, so we use the progress bar with message to let the user know what to expect.</p>
  </figcaption>
</figure>
...
<figure>
  <img src="../../images/loading-indicators/example-progress-bar-message.png" alt="" />
  <figcaption>
    <p>Messaging should tell the user what is happening and what to expect.</p>
  </figcaption>
</figure>
