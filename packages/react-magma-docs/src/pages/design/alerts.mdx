...
Use alerts to inform users of updates or changes to system status, or as feedback to an action, they have taken. Communicating with users and providing immediate feedback is important for building trust. While alerts are an effective method of communicating with users, they are disruptive and should be used with care.
...
Alerts should use simple language and as few words as possible.  Avoid using error codes or other technical languages that don't help the user know what to do next.
