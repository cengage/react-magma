...
<DocsHeading to="/api/alert/" type="code">
  Alerts
</DocsHeading>
...
Alerts may be dismissible by including a close button.

<Alert dismissible variant="info" onDismiss={()=>{}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Alert>
<Alert dismissible variant="success" onDismiss={()=>{}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Alert>
<Alert dismissible variant="warning" onDismiss={()=>{}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Alert>
<Alert dismissible variant="danger" onDismiss={()=>{}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</Alert>
<span class="horizontal-spacer"></span>
