...
Use alerts to inform users of updates or changes to system status, or as feedback to an action they have taken. Communicating with users and providing immediate feedback are important for building trust. While alerts are an effective method of communicating with users, they are disruptive and should be used with care.
...
Alerts are used to clearly communicate important information to the user and help them understand what is happening or if they need to take action on something.

### Simple

Alerts should use simple language and as few words as possible.  Avoid using error codes or other technical language that doesn't help the user know what to do next.
...
It's important to remember that not all users will see these colors in the same way, and therefore the colors and accompanying icons are simply meant to enhance the urgency of the message at a glance for some users.  The message within the alert is the most important part of the alert for all users and great care should be taken to make the message is clear.
...
When the viewport is 600px wide and smaller, we automatically hide the icon and reduce the font size to opitimize the amount of space given to the message and optional links or buttons in the alert.
...
<figure>
    ...
    <figcaption>
        ...
        <p>Do not trigger multiple toasts when a single action processes multiple identical results</p>
    </figcaption>
</figure>
...
<div class="two-col">
  <div class="row">
    <div class="col col-1">
      <figure>
        <img src="../../images/alerts/toast-error-manually-dismiss.png" alt="" />
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Toasts displaying error messages or warnings should only be manually dismissable.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        <img src="../../images/alerts/toast-successful-auto-dismiss.png" alt="" />
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>
            Toasts displaying general information or success messages may be set to auto-dismiss.
          </p>
        </figcaption>
      </figure>
    </div>
...
When the viewport is 600px wide and smaller, we automatically hide the icon and reduce the font size to opitimize the amount of space given to the message and optional links or buttons in the alert.  The toast will also automatically stretch to 100% of the viewport width with spacing around it.
...
Alerts have a number of measures built into them to improve accessibility.  Starting with the colors, we make sure that text always has at least a 4.5:1 contrast ratio with the background color.  All of the alerts can be navigated with a keyboard or screenreader.
