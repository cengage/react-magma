...
<Paragraph visualStyle="bodyLarge">
  Tables are used to organize and display data efficiently. The table component allows for customization with additional functionality, as needed by your product’s users.
</Paragraph>
...
Tables should allow user interaction so that a data display is customizable and interactive.
