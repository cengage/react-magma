...
<DocsHeading to="/api/search/" type="code">
  Search
</DocsHeading>
...
<figure>
  <img src="../../images/inputs/search-intro-image.png" alt="" />
</figure>
...
Search fields should stand out and be easy to find on the page.

### Clear

It should be clear what the search field is capable of searching for.
