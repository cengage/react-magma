...
Magma has three sets of ready-made typographic elements that you can choose from and should be adhered to when at all possible.  Each one combines a font family with calibrated sizes and weights to work within applications or editorial content.  The three sets are called **Productive**, **Expressive**, and **Narrative**.  The Productive set is used by default, but can be easily changed to Expressive or Narrative when appropriate.
...
<div class="type-details-table">
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-body-large">This is a good size for higher emphasis text, as well as the subheadline of a page.</p>
    </div>
    <div class="type-specs specs-desktop">
      <p><strong>Body / Large</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-body-medium">This is commonly used in layouts for paragraphs. The line height and size make for comfortable, long-form reading, in mediums that allow for more space. This size type is the basis for how all other text is calculated.</p>
    </div>
    <div class="type-specs">
      <p><strong>Body / Medium</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 16px / 1em</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-body-small">This is commonly used for helper and error text on inputs, as well as other explanatory text.</p>
    </div>
    <div class="type-specs">
      <p><strong>Body / Small</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 14px / .875em</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-body-xsmall">This is good to use for captions and other meta-data or explanatory text. </p>
    </div>
    <div class="type-specs">
      <p><strong>Body / X-Small</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 12px / .75em</p>
...
<div class="type-details-table">
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-xlarge">This is used for layout headings</p>
    </div>
    <div class="type-specs specs-desktop">
      <p><strong>Heading / X-Large</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-large">This is used for layout headings</p>
    </div>
    <div class="type-specs specs-desktop">
      <p><strong>Heading / Large</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 28px / 1.75em</p>
      <p>Line-height: 40px / 2.5em</p>
      <p>Weight: Semibold / 600</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-medium">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs specs-desktop">
      <p><strong>Heading / Medium</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 24px / 1.5em</p>
      <p>Line-height: 32px / 2em</p>
      <p>Weight: Semibold / 600</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-small">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs specs-desktop">
      <p><strong>Heading / Small</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 20px / 1.25em</p>
      <p>Line-height: 32px / 2em</p>
      <p>Weight: Semibold / 600</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-xsmall">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / X-Small</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 18px / 1.125em</p>
      <p>Line-height: 32px / 2em</p>
      <p>Weight: Semibold / 600</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="productive-heading-xxsmall">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / XX-Small</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 12px / .75em</p>
      <p>Line-height: 16px / 1em</p>
      <p>Weight: Bold / 700</p>
...
<div class="type-details-table">
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-body-large">This is a good size for higher emphasis text, as well as the subheadline of a page.</p>
    </div>
    <div class="type-specs">
      <p><strong>Body / Large</strong></p>
      <p>Typface: Open Sans</p>
...
<div class="type-details-table">
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-xlarge">This is used for layout headings</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / X-Large</strong></p>
      <p>Typface: Open Sans</p>
      <p>Size: 48px / 3em</p>
      <p>Line-height: 56px / 3.5em</p>
      <p>Weight: Semibold / 600</p>
      <p>Letter-spacing: 0px</p>
    </div>
  </div>
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-large">This is used for layout headings</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / Large</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-medium">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / Medium</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-small">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / Small</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-xsmall">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / X-Small</strong></p>
      <p>Typface: Open Sans</p>
  ...
  <div class="type-example">
    <div class="type-sample">
      <p class="expressive-heading-xxsmall">This is used for layout headings and component titles</p>
    </div>
    <div class="type-specs">
      <p><strong>Heading / XX-Small</strong></p>
      <p>Typface: Open Sans</p>
...
Noto Serif is a beautiful serif font. It's easy to read, provides a nice contrast with Open Sans and has great support for special characters. At this point, Noto Serif should primarily be used for the reader applications that display our text books.
...
<div class="two-col">
  <div class="row">
    ...
    <div class="col col-2">
      <p>When text is rendered by a computer, sometimes there will be characters in the text that can not be displayed, because no font that supports them is available to the computer. When this occurs, small boxes are shown to represent the characters. We call those small boxes “tofu,” and we want to remove tofu from the Web. This is how the Noto font families got their name.</p>
      
      <p>Noto helps to make the web more beautiful across platforms for all languages. Currently, Noto covers over 30 scripts, and will cover all of Unicode in the future. This is the Serif Latin, Greek and Cyrillic family. It has Regular, Bold, Italic and Bold Italic styles and is hinted.</p>
    </div>
  </div>
</div>
...
Font weight is an important typographic variable that can add emphasis and differentiate content hierarchy. Font weight and size pairings must be carefully balanced. A bold weight will always have more emphasis than a lighter weight font of the same size. However, a lighter weight font can rank hierarchically higher than a bold font if the lighter weight type size is significantly larger than the bold one. The weights available in React Magma are `light (300)`, `regular (400)`, `semi-bold (600)` and `bold (700)`.
    ...
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          ...
          <p>Text should generally be kept neutral in color until there's a reason to use a color.  </p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
  ...
  <div class="row">
    ...
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-incorrect">Incorrect</p>
          <p>The contrast between text and its background needs to be 4.5:1, or 3:1 for large (18px) text.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Appropriate color usage can help reinforce the meaning of text, but is not a replacement for clear text and other helpful visual aids like icons.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>A message is successful if you can remove the color from it, and the meaning is still clear.</p>
        </figcaption>
      </figure>
    </div>
  </div>
