...
import { Input, PasswordInput, Textarea, Paragraph } from 'react-magma-dom';
import { Link } from 'gatsby';

<DocsHeading to="/api/input/" type="design">
  Input
</DocsHeading>
<LeadParagraph>
...
The input container is filled with white and has a 1px border. The color of the border on a white background neutral03 (#727272), while the color of the border on a white background is white.
