...
However, there may be occassions where overriding the default styles is required, and this can be accomplished in a number of ways.
...
If you are using Emotion in your app, you can extend the styles of React Magma components`. This is useful if you want to add custom styles that do not fit into the`style` prop, such as styles for pseduo elements, pseudo classes, and media queries.
