...
npm install --save \
    ...
    "react@16.13.1" \
    "react-dom@16.13.1" \
    "react-magma-icons@1.0.1" \
    "uuid@8.3.0"
```

## Icons Only

The Icon library is not depenedent on react-magma being used. `react-magma-icons` can be used independently by installing the package as a dependency in your project.
