...
`Tabs` expects it's children to be of type `Tab`, be an element in which it's lowest child is of type `Tab`, or a custom component
that returns a `Tab`.
...
```.jsx
      () => {
        ...
        return (
          <TabsContainer>
            <Tabs isFullWidth={isSmallerScreen}>
              <Tab>Main Page with a longer text label</Tab>
              <Tab>FAQ</Tab>
              <Tab>About Us</Tab>
            </Tabs>
...
```.jsx
  <TabsContainer>
    <Tabs>
      <Tab component={<Link to="/api/tabs">Main page</Link>}/>
      <Tab component={<Link to="/api/tabs#nav_tabs">FAQ</Link>}/>
      <Tab component={<Link to="/api/tabs#vertical_nav_tabs">About us</Link>}/>
    </Tabs>
  </TabsContainer>
```
...
```.jsx
  <TabsContainer>
    <Tabs orientation='vertical'>
      <Tab icon={<GraduationCapIcon />}  component={<Link to="/api/tabs">Main page</Link>}/>
      <Tab icon={<AndroidIcon />}  component={<Link to="/api/tabs#nav_tabs">FAQ</Link>}/>
      <Tab icon={<BellIcon />}  component={<Link to="/api/tabs#vertical_nav_tabs">About us</Link>}/>
    </Tabs>
  </TabsContainer>
```
