...
export function Example() {
<TabsContainer>
  <Tabs aria-label="Sample With Disabled Tabs" backgroundColor={magma.colors.neutral07}>
    <Tab>Main page</Tab>
...
export function Example() {
  return (
    <div>
      <TabsContainer>
        <Tabs
          aria-label="Sample Scrollable Tabs"
          backgroundColor={magma.colors.neutral07}
        >
...
export function Example() {
  const gradIcon = <GraduationCapIcon />;
  ...
  return (
    <TabsContainer>
      <Tabs aria-label="Sample Icon Only Tabs">
        <Tab aria-label="Graduation" icon={gradIcon} />
  ...
  return (
    <TabsContainer>
      <Tabs aria-label="Sample Icon With Text Tabs">
        <Tab icon={gradIcon}>First item with a longer text label</Tab>
    ...
    <>
      <TabsContainer>
        <Tabs
          ...
          backgroundColor={magma.colors.neutral07}
          iconPosition={TabsIconPostion.left}
        >
          <Tab icon={gradIcon}>First item with a longer text label</Tab>
          <Tab icon={androidIcon}>Second item</Tab>
          <Tab icon={bellIcon}>Third item</Tab>
      ...
      <TabsContainer>
        <Tabs
          ...
          backgroundColor={magma.colors.neutral07}
          iconPosition={TabsIconPostion.bottom}
        >
          <Tab icon={<GraduationCapIcon />}>
      ...
      <TabsContainer>
        <Tabs
          ...
          backgroundColor={magma.colors.neutral07}
          iconPosition={TabsIconPostion.right}
        >
          <Tab icon={<GraduationCapIcon />}>
            First item with a longer text label
          </Tab>
  ...
  return (
    <TabsContainer>
      <Tabs
        ...
        orientation={TabsOrientation.vertical}
      >
        <Tab icon={gradIcon}>First item</Tab>
        <Tab icon={androidIcon}>Second item</Tab>
        <Tab icon={bellIcon}>Third item</Tab>
      </Tabs>
  ...
  return (
    <TabsContainer>
      <Tabs
        ...
        isInverse
        backgroundColor={magma.colors.neutral01}
      >
        <Tab>First item</Tab>
        <Tab>Second item</Tab>
        <Tab>Third item</Tab>
