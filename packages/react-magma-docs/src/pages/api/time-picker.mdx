...
The `minutesStep` prop can be used to set the stepping interval when using the arrow keys on the minutes input. The default value is 15.

```.jsx
  <TimePicker labelText="Time Due" minutesStep="5" />
```
