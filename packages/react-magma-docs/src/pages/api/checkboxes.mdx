...
<DocsHeading to="/design/selection-controls/#4._checkboxes" type="design">
  Checkboxes
</DocsHeading>
...
Custom styles can be passed into both the Checkbox component. The `containerStyle` property will apply to the container.
