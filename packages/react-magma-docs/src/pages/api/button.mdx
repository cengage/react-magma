  ...
  return (
    <>
      ...
      <p>
        ...
        <Button color={ButtonColor.secondary} variant={ButtonVariant.outline}>
          Outline
        </Button>
  ...
  return (
    <Card isInverse>
      <CardBody>
        ...
        <p>
          <Button variant={ButtonVariant.outline} isInverse>
            Outline inverse
          </Button>
        ...
        <p>
          ...
          <Button disabled isInverse variant={ButtonVariant.outline}>
            Disabled outline inverse
          </Button>
...
export function Example() {
  return (
    <>
      ...
      <Button disabled variant={ButtonVariant.outline}>
        Disabled
      </Button>
