...
`isInverse` is an optional boolean prop, that may be passed in when radio buttons are to be displayed on a dark background.

```.jsx
  <RadioGroup
    containerStyle={{ background : '#00263E', color: '#fff', padding: '10px' }}
    errorMessage="Please correct this"
