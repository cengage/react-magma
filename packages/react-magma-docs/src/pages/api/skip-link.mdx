...
When the user tabs to the first element, a hyperlink with this appearace will display in focus:

<SkipLink style={{ position: 'static' }}>Skip Navigation</SkipLink>
...
<SkipLink style={{ position: 'static' }} color="success" variant="outline">
  Skip Navigation
</SkipLink>
...
<SkipLink style={{ position: 'static' }}>Skip to main content</SkipLink>
