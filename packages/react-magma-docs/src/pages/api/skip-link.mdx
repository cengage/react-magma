...
<Button style={{ position: 'static' }}>Skip Navigation</Button>
...
<Button style={{ position: 'static' }} color="success" variant="outline">
  Skip Navigation
</Button>
...
<Button style={{ position: 'static' }}>Skip to main content</Button>
...
export default props => (
  <ScopeableLayout {...props} components={{ Button }} />
);
