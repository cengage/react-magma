...
export function Example() {
  return (
    <>
      ...
      <IconButton color="secondary" icon={<InfoIcon />} iconPosition="right">
        Icon Right
      </IconButton>
    </>
  );
...
export function Example() {
  return (
    <>
      ...
      <p>
        <IconButton icon={<BellIcon />} size="small" iconPosition="left">
          Small Notifications
        </IconButton>
        <IconButton icon={<BellIcon />} iconPosition="left">
          Medium Notifications
        </IconButton>
        <IconButton icon={<BellIcon />} size="large" iconPosition="left">
          Large Notifications
        </IconButton>
      </p>
    </>
...
export function Example() {
  return (
    <>
      ...
      <IconButton icon={<BellIcon />} isFullWidth iconPosition="right">
        Full-Width Notifications Button
      </IconButton>
