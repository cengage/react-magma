...
<Dropdown>
  ...
  <DropdownContent>
    ...
    <DropdownMenuItem disabled onClick={()=>{alert('Item 2 clicked')}}>Menu item 2</DropdownMenuItem>
  ...
  return (
    <>
      <Dropdown width='300px' maxHeight='600px'>
        ...
        <DropdownContent>
          <form style={{padding: magma.spaceScale.spacing05}}>
          ...
          <DropdownDivider />
          <div style={{textAlign: 'center', padding: magma.spaceScale.spacing05}}>
            <p>
      ...
      <Dropdown width='300px'>
        ...
        <DropdownContent>
          <form style={{ margin: '0 0 5px', color: magma.colors.neutral03 }}>
            ...
            <FormGroup labelledById='checkboxGroup' containerStyle={{ padding: `0 ${magma.spaceScale.spacing05}`}}>
            ...
            <RadioGroup labelledById='radioGroup' name='radioGroupExample' value='1' containerStyle={{ padding: `0 ${magma.spaceScale.spacing05}`}}>
