...
<DocsHeading to="/design/dropdown/" type="design">
  Dropdown
</DocsHeading>
...
```.jsx
      <>
         <Dropdown alignment='end' dropDirection='left'>
          <DropdownButton>Top-Aligned Dropleft</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem>Menu item 1</DropdownMenuItem>
            <DropdownMenuItem>Menu item number two</DropdownMenuItem>
          </DropdownContent>
        ...
        <Dropdown alignment='end' dropDirection='right'>
          <DropdownButton>Top-Aligned Dropright</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem>Menu item 1</DropdownMenuItem>
            <DropdownMenuItem>Menu item number two</DropdownMenuItem>
          </DropdownContent>
        ...
        <Dropdown alignment='end' dropDirection='down'>
         ...
         <Dropdown alignment='end' dropDirection='up'>
          <DropdownButton>Right-Aligned Dropup</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem>Menu item 1</DropdownMenuItem>
            <DropdownMenuItem>Menu item number two</DropdownMenuItem>
          </DropdownContent>
...
```.jsx
 () => {
  const OptionalDropdownMenuItem = ({toggle, dropdownMenuItemProps}) => {
    return toggle ? <DropdownMenuItem {...dropdownMenuItemProps}>Hello There</DropdownMenuItem> : null
  }
   ...
   return (
     <Dropdown>
        ...
        <DropdownContent>
          <DropdownMenuItem  onClick={()=>{alert('Item 1 clicked')}}>Menu item 1</DropdownMenuItem>
          <OptionalDropdownMenuItem toggle onClick={()=>{alert('Item 2 clicked')}}>Menu item 2</OptionalDropdownMenuItem>
          <div>
            <DropdownMenuItem  onClick={()=>{alert('Item 3 clicked')}}>Menu item 3</DropdownMenuItem>
          </div>
        </DropdownContent>
...
```.jsx
      <>
        ...
        <Dropdown>
         ...
         <Dropdown>
          <DropdownButton variant="outline" size='small'  iconPosition='right' icon={<Cog2Icon />}>Icon Right with Text</DropdownButton>
            <DropdownContent>
              <DropdownMenuItem>Menu item 1</DropdownMenuItem>
              <DropdownMenuItem>Menu item number two</DropdownMenuItem>
            </DropdownContent>
        ...
        <Dropdown>
          <DropdownButton variant="outline" size='small' iconPosition='left' icon={<Cog2Icon />}>Icon Left with Text</DropdownButton>
            <DropdownContent>
              <DropdownMenuItem>Menu item 1</DropdownMenuItem>
              <DropdownMenuItem>Menu item number two</DropdownMenuItem>
            </DropdownContent>
...
## Prevent Default Focus Handling

By default when the `dropdown` closes we put focus on the button that triggered the opening of the `dropdown`.
Sometimes this behavior will override the focusing of another element that you want to be focused. For this,
you can pass in a function named `onBeforeShiftFocus` in which you can call the `preventMagmaFocus` function on the `event`
to disable the auto-focusing on close.
...
```.jsx
  (props) => {
    ...
    return (<>
      ...
      <Dropdown>
         <DropdownButton>Without Disabling Auto Focus</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem onClick={() => setShowModal(true)}>Open Modal</DropdownMenuItem>
          </DropdownContent>
      </Dropdown>

      <Dropdown onBeforeShiftFocus={event => event.preventMagmaFocus()}>
         <DropdownButton>Disable Auto Focusing</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem onClick={() => setShowModal(true)}>Open Modal</DropdownMenuItem>
          </DropdownContent>
      </Dropdown>
...
<SimplePropsTable
  propertyValues={{
    ...
    alignment: {
      type: {
        name: 'enum',
        options: ['DropdownAlignment.start, DropdownAlignment.end'],
      },
      required: false,
    ...
    dropDirection: {
      type: {
        name: 'enum',
        options: [
          'DropdownDropDirection.down, DropdownDropDirection.left, DropdownDropDirection.right, DropdownDropDirection.up',
        ],
      },
      required: false,
