...
Using the `alignment` prop will set the alignment of the menu.

When the dropDirection is `down` or `up`, `alignment` options are `left` and `right`, with `left` being default.
When the dropDirection is `left` or `right`, `alignment` options are `bottom` and `top`, with `bottom` being default.

```.jsx
      <>
         <Dropdown alignment='top' dropDirection='left'>
        ...
        <Dropdown alignment='right'>
         ...
         <Dropdown alignment='right' dropDirection='up'>
  ...
  propertyValues={{
    ...
    alignment: {
      type: {
        name: 'enum',
        options: [
          'DropdownAlignment.left, DropdownAlignment.right',
