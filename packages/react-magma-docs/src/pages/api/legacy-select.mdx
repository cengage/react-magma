...
Please the <Link to="/select-migration">Select Migration docs</Link> for details on how to transition to the new <Link to="/api/downshift-select">Select</Link> and <Link to="/api/combobox">Combobox</Link> components.
