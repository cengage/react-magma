...
() => {
  const CustomStyledItem = styled.li(props => ({
    alignSelf: 'center',
    background: props.isFocused ? props.theme.colors.neutral : 'transparent',
    borderColor: props.isFocused ? props.theme.colors.pop : 'transparent',
    lineHeight: '24px',
    margin: '0',
    padding: '8px 16px',
    "&::before": {
