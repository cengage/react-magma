...
The `value` of an input can be initially set using the `defaultValue` prop.
...
display a help link to the right of the input field. The text can be customized using the optional `helpLinkAriaLabel` prop.

```.jsx
   <Input
      helpLinkAriaLabel='Learn more about help links'
      labelText='Help Link'
