...
By default, users can show the password, by pressing a toggle button. To prevent users from showing the password, the optional boolean `isPasswordMaskButtonHidden` can be used.
