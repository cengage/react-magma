...
import { Input, Button, CalendarIcon, Search2Icon } from 'react-magma-dom'
...
<SimplePropsTable
  props={{
    ...
    size: {
      type: {
        name: 'enum',
        options: ['inputSize.medium', 'inputSize.large'],
      },
      description: 'The relative size of the component',
      defaultValue: 'medium',
    },
    testId: {
      type: {
...
export default props => (
  <ScopeableLayout
    {...props}
    components={{ Input, Button, CalendarIcon, Search2Icon }}
  />
)
