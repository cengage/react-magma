...
import React from 'react';
import { NavTab, NavTabs } from 'react-magma-dom';
import { GraduationCapIcon, AndroidIcon, BellIcon } from 'react-magma-icons';
export function Example() {
  return (
    <NavTabs aria-label="Icon Only Nav Tabs">
      <NavTab
        aria-label="Graduation"
        icon={<GraduationCapIcon isActive />}
        to="#"
      />
...
export function Example() {
  return (
    <NavTabs aria-label="Icon with Text Nav Tabs" isFullWidth>
      <NavTab icon={<GraduationCapIcon />} isActive to="#">
        First item with a longer text label
      </NavTab>
      <NavTab icon={<AndroidIcon />} to="#">
        Second item
      </NavTab>
      <NavTab icon={<BellIcon />} to="#">
        Third item
      </NavTab>
    </NavTabs>
  );
