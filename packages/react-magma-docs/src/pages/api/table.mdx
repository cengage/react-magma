...
```.jsx
    <Card>
        <Table>
            <TableHead>
                <TableRow>
                    <TableHeaderCell  onSort={()=>{console.log('onSort')}} isSortable sortDirection="ascending">Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
...
The `minWidth` prop specifies the number in pixels for the minimum width of the table.
