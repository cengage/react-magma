            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableHeaderCell onSort={()=>{requestSort('stock')}} isSortable align="right" sortDirection={sortConfig.key === 'stock' ? sortConfig.direction : "none"}>In Stock 3</TableHeaderCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {products.map((item) => (
