...
```.jsx
    <Card>
        <Table>
            <TableHead>
                <TableRow>
                    <TableHeaderCell  onSort={()=>{console.log('onSort')}} sortable sortDirection="ascending">Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
                    <TableHeaderCell  onSort={()=>{console.log('onSort')}} sortable align="right">Number</TableHeaderCell>
                </TableRow>
            </TableHead>
            <TableBody>
                <TableRow>
...
```.jsx
    <Card background={magma.colors.neutral01} isInverse>
        <Table isInverse hasZebraStripes hasVerticalBorders>
            <TableHead>
                <TableRow>
                    <TableHeaderCell sortable sortDirection="ascending">Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
                    <TableHeaderCell>Column</TableHeaderCell>
