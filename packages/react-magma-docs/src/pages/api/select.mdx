...
For all of the select variants you will have to wrap your render functions in an asynchronous function to allow it to load.
Here is an example of a basic test for `Select`:
