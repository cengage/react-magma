...
For this example I am importing `components` from `react-select` and renaming the import to `ReactSelectComponents`. In practice you should not have a component defined inside of your `render` function, but it is there in this example to allow you to see how to build a custom component.
