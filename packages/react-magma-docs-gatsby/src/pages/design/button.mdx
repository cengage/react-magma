...
<div class="two-col">
  <div class="row">
    <div class="col col-1 example-good">
      <figure>
    ...
    <div class="col col-2 example-bad">
      <figure>
  ...
  <div class="row">
    <div class="col col-1 example-bad">
      <figure>
    ...
    <div class="col col-2 example-caution">
      <figure>
  ...
  <div class="row">
    ...
    <div class="col col-2 example-bad">
      <figure>
        ...
        <figcaption>
          <p class="title title-incorrect">Correct</p>
  ...
  <div class="row">
    <div class="col col-1 example-good">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Incorrect</p>
...
<div class="two-col">
  <div class="row">
    ...
    <div class="col col-2 example-good">
      <figure>
