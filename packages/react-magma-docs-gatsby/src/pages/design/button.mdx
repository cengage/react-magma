...
<DocsHeading to="/api/button/" type="code">Buttons</DocsHeading>
...
<button class="StyledButton__StyledButtonComponent-sc-8kiq4d-0 gweYkq" color="primary" shape="fill">BUTTON LABEL</button>

2. Outlined Button (medium emphasis)
Outlined buttons are used for more emphasis than text buttons due to the stroke
<button class="StyledButton__StyledButtonComponent-sc-8kiq4d-0 glsKz" color="primary" shape="fill">BUTTON LABEL</button>

3. Solid button (high emphasis)
Solid buttons have more emphasis, as they use use a color fill
<button class="StyledButton__StyledButtonComponent-sc-8kiq4d-0 cekKaY" color="primary" shape="fill">BUTTON LABEL</button>
    ...
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          ...
          <p>Don’t wrap text. For maximum legibility, a text label should remain on a single line.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Text labels can be written in sentence case, as long as the button is clearly distinguishable from elements around it.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col">
  ...
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Text buttons don’t typically need a container when in all caps, because the label is differentiated from the text around it.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          ...
          <p>Text labels need to be distinct from other elements. Without a container, the button above could be hard to distinguish from the content above it.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>You can use icons without a text label if testing proves that the intended action of the button is clear to the users.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-incorrect">Incorrect</p>
          <p>Don’t vertically align an icon and text in the center of a contained button.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
  ...
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Use the <strong>Primary</strong> colored button for the primary action unless there is a specific reason to use something else.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Consider using the <strong>Success</strong> variation for buttons that will execute an action that creates something new.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>Consider using the <strong>Danger</strong> variation for buttons that will remove or destroy something to help emphasize the danger that comes with clicking that button.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>When using multiple buttons, you can place a text button next to a solid button to show emphasis.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>When using multiple buttons in the bottom bar of a modal, the buttons align to the right with the most important button on the far right.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>You can place a text button (low emphasis) next to an outlined button (medium emphasis).</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-incorrect">Incorrect</p>
          <p>Avoid using two solid buttons next to one another if they don’t have the same fill color.</p>
        </figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>You may allow the buttons to go block level if it benefits the design or if there isn’t enough room for them to remain side-by-side.</p>
        </figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        ...
        <figcaption>
          <p class="title title-correct">Correct</p>
          <p>No need to force buttons to be block level if they fit in the container without problem.</p>
        </figcaption>
      </figure>
    </div>
  </div>
