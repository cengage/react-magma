...
For more information, including information on contributing to React Magma and running the project locally, see the [Stash Repository](http://stash.corp.web:7990/projects/FRONT/repos/react-magma/browse).
