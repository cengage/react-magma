...
const IndexPage = () => (
  <Layout>
    <Global styles={css`
      .content { background: #00263E; color: #fff; } 
      .content-article { background: #003865; margin: 0; max-width: none; width: auto; } 
    `} />
    <IntroNav />

    <IntroSection id="sectionIntro" style={{marginTop: '70px'}}>
    ...
    <IntroSection id="sectionComponents">
    ...
    <IntroSection id="sectionQuality">
    ...
    <IntroSection id="sectionAccessible" >
    ...
    <IntroSection id="sectionEvolving">
    ...
    <Footer>
      <h2 style={{margin: '0 0 0.5em 0', padding: 0}}>Contact us anytime</h2>
      <p>If you have questions or you’d like to be personally involved in helping React Magma be the best it can be, please reach out to us on Slack — #magma.</p>
    </Footer>
  </Layout>
)
