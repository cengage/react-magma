...
const colors = {
  ...
  tertiary: rebrandColors.cyan700,
  neutral: neutralColors.neutral600,
  info: rebrandColors.blue600,
  danger: rebrandColors.red600,
  warning: rebrandColors.yellow700,
  success: rebrandColors.green600,
  ...neutralColors,
  ...rebrandColors,
  ...dataVizColors,

  focus: rebrandColors.blue500,
  focusInverse: rebrandColors.blue400,
