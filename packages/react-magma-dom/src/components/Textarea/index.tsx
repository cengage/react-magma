...
import { inputBaseStyles, InputBaseStylesProps, InputWrapperStylesProps, inputWrapperStyles } from '../InputBase';
...
const StyledTextArea = styled.textarea<InputWrapperStylesProps & InputBaseStylesProps>`
  ${inputBaseStyles};
  ${inputWrapperStyles};
  height: 4.5em;
  padding: ${props =>
