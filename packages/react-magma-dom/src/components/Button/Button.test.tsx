...
//     expect(getByText(BASE_BUTTON_PROPS.children.toString())).not.toBeNull();
//   });

//   it('should autofocus a button when the passed autoFocus', () => {
//     const { getByText } = renderButton({ autoFocus: true });

//     expect(getByText(BASE_BUTTON_PROPS.children.toString())).toHaveFocus();
//   });

//   it('should disable a button when the passed disabled', () => {
//     const { getByText } = renderButton({ disabled: true });

//     expect(getByText(BASE_BUTTON_PROPS.children.toString())).toBeDisabled();
//   });
...
//     //       const button = getByText(BASE_BUTTON_PROPS.children.toString());
//     //
...
//     fireEvent(
//       getByText(BASE_BUTTON_PROPS.children.toString()),
