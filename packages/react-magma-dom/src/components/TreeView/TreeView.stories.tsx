...
export const Simple = {
  ...
  parameters: { controls: { exclude: ['isInverse'] } },
};
            ...
            >
              ...
              >
                <TreeItem
                  ...
                  label={
                    <>
                      Section 3.1: Topping pudding marshmallow caramels I love
                      pie
                    </>
                  }
                  itemId="pt1ch3.1"
                ...
                <TreeItem
                  ...
                  label={
                    <>
                      Section 3.2: Tart sweet roll caramels candy canes sweet
                      roll
                    </>
                  }
                  itemId="pt1ch3.2"
                ...
                <TreeItem
                  ...
                  label={
                    <>
                      Section 3.3: Tart sweet roll caramels candy canes sweet
                      roll
                    </>
                  }
                  itemId="pt1ch3.3"
      ...
      <>
        <p>
          <em>
            ...
            Expect only the following items to be expandable: Node 1, Child 1,
            Node 2, Child 2, Grandchild 2, Node 6.
          </em>
        </p>
        <TreeView {...args}>
...
export const AccordionSectionWithTreeView = (props: any) => {
  const {
    trees,
    title,
...
export const AccordionTreeWithShowAllAndExpandAll = {
  render: (props: any) => {
    const apiRef = React.useRef<TreeViewApi>();
...
export const ComplexTreeWithLargeDataSet = {
  render: (args: Partial<TreeViewProps>) => {
    const treeContent = {
      id: 'tree-id',
      groupName: 'disciplines',
  ...
  render: (args: Partial<TreeViewProps>) => {
    ...
    return (
      <>
        ...
        <button onClick={addNewParentItemUnchecked}>
...
export const ComplexWithAdditionalContent = {
  render: (args: Partial<TreeViewProps>) => {
    const treeLabel = () => {
      return (
        <Flex
