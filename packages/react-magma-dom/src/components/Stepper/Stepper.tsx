...
const StyledSeparator = typedStyled.div<{
  ...
  width: ${props => (props.showLabelsLayout ? 'calc(100% - 24px)' : '100%')};
  height: 2px;
  top: 11px;
  left: ${props => (props.showLabelsLayout ? 'calc(50% + 12px)' : '')};
  position: ${props => (props.showLabelsLayout ? 'absolute' : 'relative')};
  align-self: baseline;
