...
- d368a9894: chore(deps): Republish to align the `react-magma-dom` peer dependency with the 4.14.0 release.
...
- e23b1a2f9: fix(Dropzone): Improve accessibility for file management.
...
- 46260e57c: fix(Dropzone): fix type declaration path for Dropzone component
