...
The input container is filled with white and has a 1px border. The color of the border on a white background neutral03 (#707070), while the color of the border on a white background is white.
