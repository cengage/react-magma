...
export function Example() {
  return <Pagination count={4}></Pagination>;
}
```
...
export function Example() {
  return (
    <Card isInverse>
      <CardBody>
        <Pagination isInverse count={4}></Pagination>
      </CardBody>
    </Card>
  );
}
...
export function Example() {
  return <Pagination size="large" count={4}></Pagination>;
}
```
...
export function Example() {
  ...
  return (
    <div>
      ...
      <Pagination onPageChange={handlePageChange} count={4}></Pagination>
    </div>
  );
}
```
