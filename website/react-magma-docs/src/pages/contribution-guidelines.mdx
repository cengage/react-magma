...
<LeadParagraph>
  We welcome anyone who would like to contribute to Magma. Working with the
  Magma team, you may contribute your skills to making our design
  system better.
</LeadParagraph>

## Ways to Contribute

There are many ways to contribute to the [Magma project on Github](https://github.com/cengage/react-magma). Here are just a few:
...
If you find a bug or piece of documentation requiring an update, you may [open a new issue](https://github.com/cengage/react-magma/issues) for the Magma team to address, or you can fix the issue yourself and submit your own pull request.
...
Explain how your idea will add value to the system. Magma serves a wide range of products, and contributions that prove to be relatively universal and easy to reuse are more likely to be accepted.

### Design Ideas

Have a great idea for Magma but you’re not a developer? No problem. Submit designs in the form of wireframes or high-fidelity mockups for new components and work with our team to bring them to life.

### Sketch Symbols or Design Assets

If you are creating a brand new component or enhancing the presentation of an existing component, then there probably needs to be a corresponding update to the Sketch symbol libraries for Magma. Anyone can create new Sketch symbols, but they have to be added to the actual libraries by someone on the Cengage UX team. View the Sketch documentation for working with symbols and libraries.

### Working Code

The component or enhancement must be built in React and follow the standards set by the Magma team. More details for contributing to the code for Magma can be found in the Github repository.
...
The Magma team puts a lot of time, effort, and thought into making decisions around all aspects of the implementation of this component library. That effort includes ensuring that the Magma code maintains a consistent look and feel across the entire repository. Before starting on your first PR please make sure to have a look at other components to see the different convention choices and structure. If you do see something that you believe should be changed, added, or might benefit from your unique perspective, please bring it to the Magma team for discussion before making that change in your new component or fix.
...
The need for a new or updated component often arises when a specific design problem is being solved. But because Magma is intended for use across many different products, we must broaden our view to include how it might be used or impact other applications.
...
Every component should be designed using the standardized styles of Magma, including typography, spacing, and colors. We also very often put our components on dark backgrounds instead of only light backgrounds, so please think through whether the component needs an inverse version.

### Responsive Behavior

Magma is primarily used for web applications, and we believe strongly that every component and UI should have Responsive behavior. For a component, this means you need to think through how the component might change as the viewport of the device changes. This could involve the following:
