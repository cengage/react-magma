...
<Alert variant="danger">
  <strong>LineChart is deprecated.</strong> See the{' '}
  <Link to="/data-visualization/chart-demos/">Data Visualization section</Link>{' '}
  for all available charts.
</Alert>

<LeadParagraph>A line chart component</LeadParagraph>
...
const componentProps = {
  xAxis: {
    ...
    tickFormat: (d, i) => ['Jan', 'Feb', 'March', 'April', 'May'][i] || '',
  },
  yAxis: {
    domain: [10, 80] as any,
...
export function Example() {
  return (
    <Chart
      ...
      type="line"
      lastFocusedScatterPoint={undefined as any}
      pointRefArray={undefined as any}
      registerPoint={undefined as any}
      tabRef={undefined as any}
      unregisterPoint={undefined as any}
    />
  );
}
```
