...
<Alert variant="danger"><strong>LineChart is deprecated.</strong> Use <Link to="/api/chart/">Chart</Link> instead.</Alert>

<LeadParagraph>A line chart component</LeadParagraph>

<Alert variant="warning"><strong>Important!</strong> LineChart is imported from <code>@react-magma/charts</code> which must be installed as a peer dependency.</Alert>
