...
<Alert variant="warning">
  ...
  <inlineCode>&lt;ul&gt;</inlineCode> element with each checkbox inside a{' '}
  <inlineCode>&lt;li&gt;</inlineCode> element. This ensures proper semantic HTML
  structure and improves accessibility.
</Alert>
