...
export function Example() {
  return (
    <>
      ...
      >
        <Dropdown>
          <DropdownButton aria-label="Dropdown 1">1</DropdownButton>
          <DropdownContent>
  ...
  return (
    <>
      ...
      <ButtonGroup orientation={ButtonGroupOrientation.horizontal} noSpace>
        ...
        <Dropdown>
          <DropdownButton aria-label="Dropdown 2">2</DropdownButton>
          <DropdownContent>
            <DropdownMenuItem>Menu item 2</DropdownMenuItem>
          </DropdownContent>
        </Dropdown>
        <Dropdown>
          <DropdownButton aria-label="Dropdown 3">3</DropdownButton>
          <DropdownContent>
