...
export function Example() {
  ...
  return <Pagination count={10} page={page} onPageChange={handleChange} />;
}
```
...
import { Pagination, PageButtonSize } from 'react-magma-dom';
...
export function Example() {
  ...
  return (
    <div>
      ...
      <Pagination page={page} onPageChange={handlePageChange} count={4} />
    </div>
  );
}
```
