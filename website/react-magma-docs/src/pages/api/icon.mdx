...
<Alert variant="warning"><strong>Important!</strong> Icons are now imported from{' '}<code>react-magma-icons</code> which must be installed as a peer dependency.</Alert>
