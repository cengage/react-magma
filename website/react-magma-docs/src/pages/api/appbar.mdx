...
<PageContent componentName="appbar" type="api">

<LeadParagraph>
  The AppBar component is a relatively simple container, rendering a header
  element, used to display information and actions relating to the current
  screen.
  <br />
  <br />
  It is the foundation for the <Link to="/patterns/header">Header Pattern</Link>
  , a more robust, more opinionated component that also handles the rendering of
  several components inside of it.
</LeadParagraph>
