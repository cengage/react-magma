...
```typescript
import React from 'react';
import { Datagrid, Card, usePagination } from 'react-magma-dom';
...
Props to be used in the `usePagination` hook. There is a controlled and uncontrolled interface for the props.
