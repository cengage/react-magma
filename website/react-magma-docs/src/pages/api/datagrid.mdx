...
```typescript
import React from 'react';
import { Datagrid, Card, useDataPagination } from 'react-magma-dom';
...
# UseDataPagination props

Props to be used in the `useDataPagination` hook. There is a controlled and uncontrolled interface for the props.
