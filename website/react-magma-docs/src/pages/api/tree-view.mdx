    ...
    <>
      <TreeView ariaLabel="icon-example">
        <TreeItem
          ...
          icon={
            <FavoriteIcon
              style={{ color: magma.colors.indigo500 }}
              aria-hidden
            />
          }
          itemId="1"
...
import { TreeView, TreeItem, Card, magma } from 'react-magma-dom';
    ...
    <>
      <TreeView ariaLabel="custom-label">
        <TreeItem
          ...
          labelStyle={{ color: magma.colors.red600 }}
        >
          <TreeItem
            label="Snakes"
        ...
        <TreeItem label="Aquatic Animals" itemId="custom-Aquatic Animals">
          ...
          <TreeItem
            ...
            labelStyle={{ color: magma.colors.green700, fontWeight: '600' }}
            style={{ background: magma.colors.green100 }}
          >
