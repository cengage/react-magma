  ...
  return (
    <>
      ...
      <ButtonGroup size={ButtonSize.small} variant={ButtonVariant.solid}>
        <Button
          onClick={() => apiRef.current && apiRef.current.selectAll()}
          color={ButtonColor.secondary}
        >
          Select all
        </Button>
        <Button
          onClick={() => apiRef.current && apiRef.current.clearAll()}
          color={ButtonColor.secondary}
        >
          Clear all
        </Button>
...
export function Example() {
  ...
  const toggleExpandAll = () => {
    apiRef.current && apiRef.current.expandAll();
  };

  const toggleCollapseAll = () => {
    apiRef.current && apiRef.current.collapseAll();
  };
