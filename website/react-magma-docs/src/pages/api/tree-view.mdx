...
```typescript
import React from 'react';
import { TreeView, TreeItem, TreeViewSelectable, Flex, FlexBehavior, FlexAlignContent, FlexAlignItems, FlexJustify, Paragraph, Tag, TagSize, ButtonColor, ButtonVariant, ButtonSize, IconButton } from 'react-magma-dom';
import { MoreHorizIcon } from 'react-magma-icons';

export function Example() {
  return (
      <TreeView selectable={TreeViewSelectable.off}>
        <TreeItem label="Folders" itemId="Folders">
          <TreeItem
            label={
              <Flex
              ...
              >
                <Flex behavior={FlexBehavior.item}>
                  <Paragraph noMargins>Inbox</Paragraph>
                </Flex>
                <Flex behavior={FlexBehavior.item}>
                  <Tag size={TagSize.small}>54</Tag>
                </Flex>
              </Flex>
            }
            itemId="Inbox"
          />
          <TreeItem label="Drafts" itemId="Drafts" />
          <TreeItem label="Sent Items" itemId="SentItems" />
        </TreeItem>
        <TreeItem label="Favorites" itemId="Favorites">
          <TreeItem
            label={
              <Flex
                behavior={FlexBehavior.container}
              ...
              >
                <Flex behavior={FlexBehavior.item}>
                  <Paragraph noMargins>Important</Paragraph>
                </Flex>
                <Flex behavior={FlexBehavior.item}>
                  <Tag size={TagSize.small}>13</Tag>
                </Flex>
              </Flex>
            }
            itemId="Important"
        ...
        <TreeItem
          label={
            ...
            >
              <Flex behavior={FlexBehavior.item}>
                <Paragraph noMargins>Junk Mail</Paragraph>
              </Flex>
              <Flex behavior={FlexBehavior.item}>
                <IconButton
                  aria-label="Settings"
