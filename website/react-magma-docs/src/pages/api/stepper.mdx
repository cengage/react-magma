...
The `orientation` prop allows you to change the orientation of the `Stepper`. By default, the `Stepper` is displayed horizontally unless the `orientation` prop is specified.
