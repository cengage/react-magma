  ...
  return (
    <>
      ...
      <ButtonGroup>
        ...
        <IconButton icon={<CheckIcon />} variant={ButtonVariant.link} aria-label="Check">
          Submit
        </IconButton>
      </ButtonGroup>
    </>
...
export function Example() {
  ...
  return (
    <IconButton aria-label="Notifications" icon={icon}>Notification with Custom Icon Size</IconButton>
  );
}
```
...
export function Example() {
  return (
    <ButtonGroup>
      <IconButton icon={<NotificationsIcon />} aria-label="Notifications">Icon Left</IconButton>
      <IconButton
        color={ButtonColor.secondary}
        icon={<InfoIcon />}
...
export function Example() {
  return (
    <>
      <IconButton icon={<NotificationsIcon />} isFullWidth aria-label="Notifications">
