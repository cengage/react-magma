...
The `isDisabled` property will disable the ability to open the popover. For disabled trigger and enabled content, you need to place the disable button inside the trigger and use the `hoverable` property.
