...
<PageContent componentName="button" type="api">
...
Colors for buttons include `primary`, `secondary`, `subtle`, `danger`, and `marketing` with `primary` being the default value.
