...
<LeadParagraph>
  Buttons are clickable items used to perform an action. See the{' '}
  <Link to="/design/button/">Button Design Guidelines</Link> for more
  information on when to use the different kinds of buttons.
</LeadParagraph>
