...
<LeadParagraph>
  The `Fieldset` component renders a semantic &lt;fieldset&gt; element with a
  &lt;legend&gt; to provide accessible grouping for related controls such as
  *checkboxes* and *radios*. This follows the WCAG technique H71 and aligns with
  the WAI-ARIA APG checkbox pattern for grouping form controls.
</LeadParagraph>
