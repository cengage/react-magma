  ...
  return (
    <RadioGroup labelText="Text position" name="textPosition">
      <Radio
        ...
        value="1"
      />
      <Radio labelText="Text right" value="2" />
    </RadioGroup>
  );
}
```
