...
You can use `CustomTab` to fully customize the look and feel of your tabs, while keeping all accessibility and keyboard navigation features.
...
export function Example() {
  ...
  return (
    <StyledTabsContainer>
      <Tabs aria-label="Sample Tabs">
        <CustomTab>
          <StyledButton>Magma Button</StyledButton>
        </CustomTab>
        <CustomTab>
...
<Alert variant="warning"> <strong>Important</strong> ScrollSpy is a beta component. Please use at your own risk.</Alert>
