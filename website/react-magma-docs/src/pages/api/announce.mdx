...
import { Announce, AnnouncePoliteness, Button } from 'react-magma-dom';
...
export function Example() {
  ...
  return (
    <>
      ...
      <Announce politeness={AnnouncePoliteness.assertive}>
      ...
      <Announce politeness={AnnouncePoliteness.off}>
