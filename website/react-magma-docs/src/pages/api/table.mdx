...
<Alert variant="warning">To improve accessibility, when using the <inlineCode>isSortable</inlineCode>{' '} prop, it is recommended to also include the <inlineCode>header</inlineCode>{' '}prop with a string value that indicates the name of the column. This will be used in the <inlineCode>aria-label</inlineCode> for the sort button to provide more context for screen reader users.</Alert>
