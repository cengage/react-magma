...
const springfieldDonut = Object.assign({}, magma, {
  ...
  typeScale: Object.assign({}, magma.typeScale, {
    size02: {
      fontSize: '16px',
      letterSpacing: '-1px',
    },
...
const StyledCardHeading = styled.h1`
  ...
  text-shadow: -5px 1px #a15936, -5px -1px #a15936, -5px 0px 2px #a15936, -5px
      4px 2px #a15936, 1px 4px 2px #a15936;
  &:before {
    color: white;
    content: 'Doh';
    position: absolute;
    ...
    <ThemeContext.Provider value={springfieldDonut}>
      ...
      <StyledCard>
        ...
        <CardBody>
          ...
          <AppBar style={{ borderRadius: '6px' }}>AppBar</AppBar>
