...
const StyledCardHeading = styled.h1`
  color: #939c55;
  text-shadow: 0 0 2px rgb(0 0 0 / 40%), 0 0px 1px rgb(0 0 0 / 40%);
  font-size: 40px;
`;
...
const StyledDonut = styled.div`
  ...
  &:before {
    ...
    box-shadow: 0 12px 13px -14px black;
  }
  &:after {
    content: '';
    background: #ce8b97;
    box-shadow: inset 0 -24px 2px rgb(255 255 255 / 12%), 0 22px 13px rgb(0 0
            0 / 16%), inset 0 -10px 12px 2px rgb(255 255 255 / 17%), inset 0 0,
      inset 0 -12px 23px 22px rgb(255 255 255 / 36%), inset 0 30px 21px 20px
        pink, inset 0 -20px 21px 20px pink, inset 0 -110px 0px -27px pink,
      inset 0 -10px 0 10px white;
    position: absolute;
    top: -23px;
    left: 6%;
    width: calc(58%);
