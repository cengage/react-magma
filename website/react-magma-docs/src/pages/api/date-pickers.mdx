...
By default, the component uses the `MM/dd/yyyy` date format. This can be changed in the I18nContext. In addition to the default, the component supports the following formats: `dd/MM/yyyy`, `yyyy/MM/dd` and `yyyy/dd/MM`.
