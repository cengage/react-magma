...
<Alert variant="warning">
  Toast messages can only be 1 or 2 lines long and have a max-width of 600px. If your message is longer than that, please shorten it or use a different component.
</Alert>
