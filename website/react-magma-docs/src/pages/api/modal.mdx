...
export function Example() {
  ...
  const smallButtonRef = React.useRef<HTMLButtonElement>(null);
  const largeButtonRef = React.useRef<HTMLButtonElement>(null);
    ...
    <>
      <Modal
        ...
        onClose={() => {
          ...
          smallButtonRef.current && smallButtonRef.current.focus();
        }}
      ...
      <Modal
        ...
        onClose={() => {
          ...
          largeButtonRef.current && largeButtonRef.current.focus();
        }}
...
The modal header prop is optional. It can accept a node or a string, and will be rendered inside an H2 by default.
The level of the header can be changed using the `headerLevel` prop.
...
export function Example() {
  ...
  const headerRefButtonRef = React.useRef<HTMLButtonElement>(null);
    ...
    <>
      ...
      <Modal
        ...
        onClose={() => {
          ...
          headerButtonRef.current && headerButtonRef.current.focus();
        }}
      ...
      <Modal
        ...
        onClose={() => {
          ...
          headerRefButtonRef.current && headerRefButtonRef.current.focus();
        }}
      ...
      >
        ...
        >
          ...
          <ButtonGroup>
            <Button
              onClick={() =>
                customHeadingRef.current && customHeadingRef.current.focus()
              }
