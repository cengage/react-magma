---
pageTitle: File Uploader Design Guidelines
title: File Uploader
order: 1
---
...
<DocsHeading to="/api/file-uploader/" type="design">
  File Uploader
</DocsHeading>
<LeadParagraph>
  File uploaders allow users to upload their own content.  They are commonly used within forms but may also exist on their own.
</LeadParagraph>

![ ](../../images/file-uploader/uploader-intro-image.png)

## Usage

Use the React Magma file uploader when you want... 
...
![ ](../../images/file-uploader/uploader-dropzone-anatomy.png)
...
![ ](../../images/file-uploader/uploader-anatomy.png)
...
![ ](../../images/file-uploader/uploaded-file-anatomy.png)
...
![ ](../../images/file-uploader/loading-states.png)
...
![ ](../../images/file-uploader/file-types.png)

### Overflow

If the name of the file is too long for the space allowed within the container, it will be truncated with an ellipsis (...)

![ ](../../images/file-uploader/uploaded-file-overflow.png)

---

## Validation

When there’s an error uploading a specific file, that file will show an error state with a message.  Make sure the message describes how the user can fix the issue.  If the file upload is part of a larger form, you may also include an inline alert at the top of the form.

![ ](../../images/file-uploader/file-validation.png)
...
![ ](../../images/file-uploader/uploader-validation.png)
