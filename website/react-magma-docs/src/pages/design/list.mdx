...
<DocsHeading to="/api/list/" type="design">
  List
</DocsHeading>
<LeadParagraph>
  ...
  <div class="row">
    <div class="col col-1">
      <figure>
        ...
        <figcaption>The list in this image shows a list of grocery items in no particular order.</figcaption>
      </figure>
    </div>
    <div class="col col-2">
      <figure>
        <img src="../../images/lists/ordered-list.png" alt=" " />
        <figcaption>The list in this image shows a list of the top 7 best-selling car brands.</figcaption>
      </figure>
    </div>
  </div>
</div>
