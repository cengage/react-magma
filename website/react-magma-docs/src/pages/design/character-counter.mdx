...
<DocsHeading to="/api/character-counter/" type="design">
  Character Counter
</DocsHeading>
<LeadParagraph>
  Character counter helps users know how much text they can enter when there is a limit on the number of characters.
</LeadParagraph>
