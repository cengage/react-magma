...
How we use color within the progress bar component is extremely important for meeting accessibility requirements (WCAG 2.2).

### Track

The default track has a white background and the border is #8F8F8F. This gray was specifically added to the palette as the lightest gray possible to meet the 3:1 contrast ratio required for accessibility (WCAG 2.2). It is especially useful for borders like this.
