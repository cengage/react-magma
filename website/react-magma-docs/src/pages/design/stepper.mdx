...
- <a href="https://www.w3.org/WAI/tutorials/forms/multi-page/">
    W3C Web Accessibility Tutorial for Multi-Page Forms
  </a>
  provides examples of how to create accessible progress indicators.
