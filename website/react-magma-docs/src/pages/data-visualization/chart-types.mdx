...
Every chart type listed below is rendered in [Chart Demos](../chart-demos) with the accessible Magma toolbar enabled, providing a "Show as table" data view, fullscreen toggle, and downloads (CSV, PNG, JPG). See [Getting Started](../introduction#accessible_chart_toolbar) for the implementation details and accessibility rationale.
...
<div className="container">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/bubble.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/radar.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/lollipop.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/combo.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
...
<div className="container">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/boxplot.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/step.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
...
<div className="container">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/bullet.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/meter.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
  ...
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/gauge.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
...
<div className="container">
  <div className="item">
    <figure>
      <img
        className="chart-types-image"
        src="../../images/chart-types/scatter.jpg"
        alt=" "
      />
    </figure>
    <div className="description">
