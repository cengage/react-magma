...
See [Chart Demos](../chart-demos) for examples of every chart type with the accessible toolbar enabled, and the [Toolbar customization](../chart-demos#toolbar-customization) section for advanced configurations (custom menu items, table columns, button visibility, inverse theme).
