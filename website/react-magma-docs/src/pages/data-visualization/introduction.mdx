...
| Issue ----------------------------------------------------------------------- | Status | <br />
| ----------------------------------------------------------------------------- | ------ | <br />
| Focus does not move to close button when table dialog opens ---------------- | &nbsp;Fixed&nbsp; | <br />
| Incorrect `aria-haspopup` on "Show as Table" and "Fullscreen" buttons ------ | &nbsp;Fixed&nbsp; | <br />
| Chart title uses `<p role="heading">` instead of `<h2>` -------------------- | &nbsp;Fixed&nbsp; | <br />
| "Show as table" label is not descriptive enough ------------------------------ | &nbsp;Fixed&nbsp; | <br />
| Table dialog missing a semantic heading ------------------------------------- | &nbsp;Fixed&nbsp; | <br />
| Table heading not semantic (`<div>` instead of `<th>`) ---------------------- | &nbsp;Fixed&nbsp; | <br />
| Screen reader announces extra content on button focus --------------------- | &nbsp;Fixed&nbsp; | <br />
| Screen reader silent after activating "Show as table" ------------------------- | &nbsp;Fixed&nbsp; | <br />
