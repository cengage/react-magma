...
<DocsHeading to="/api/icon/" type="design">
  Icons
</DocsHeading>
<LeadParagraph>
...
We do our best to keep up with any updates that happen on Material Design's icons, and that includes the [icon library](https://www.dropbox.com/home/React-Magma-Sketch) we maintain for Sketch.
