...
Our primary typeface is Inter. It’s clear and approachable and works well for headlines, subheads, navigation, and body copy.
...
Inter was designed for computer screens. Its tall x-height and carefully drawn
punctuation support legibility across interface sizes, while its broad range of
weights makes it suitable for both text and display use.

### Noto Serif

Noto Serif is a beautiful serif font. It's easy to read, provides a nice contrast with Inter and has great support for special characters. At this point, Noto Serif should primarily be used for the reader applications that display our text books.
