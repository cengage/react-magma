...
<figure>
  <img
    ...
    alt="Full-width page layout with a header spanning the page and a twelve-column content grid below."
  />
</figure>
    ...
    >
      <GridItem gridColumn="1 / 5">
        <AppBar
          ...
          style={{
            backgroundColor: magma.colors.blue600,
            color: magma.colors.neutral0,
          }}
        />
      </GridItem>
      ...
      >
        <div
          style={{
            background: magma.colors.blue400,
      ...
      <GridItem
        gridColumn="1 / 5"
        style={{
          backgroundColor: magma.colors.blue300,
          color: magma.colors.brand.navy,
          textAlign: 'center',
          padding: magma.spaceScale.spacing05,
          width: 'calc(100% - 48px)',
      ...
      <GridItem
        ...
        style={{
          backgroundColor: magma.colors.blue400,
          color: magma.colors.brand.navy,
          textAlign: 'center',
          padding: magma.spaceScale.spacing05,
...
<figure>
  <img
    ...
    alt="Restricted-width page layout with a centered content grid and wide margins on both sides."
  />
</figure>
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            background: magma.colors.blue300,
            color: magma.colors.brand.navy,
            padding: magma.spaceScale.spacing05,
            height: '100%',
          }}
...
<figure>
  <img
    ...
    alt="Page layout with a full-height left sidebar and a header spanning the content area to its right."
  />
</figure>
...
<figure>
  <img
    ...
    alt="Page layout with a full-width header above a left sidebar and the main content area."
  />
</figure>
