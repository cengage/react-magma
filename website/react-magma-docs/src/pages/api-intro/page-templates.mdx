  ...
  return (
    ...
    >
      ...
      <GridItem
        gridColumn="1 / 5"
        style={{
          backgroundColor: magma.colors.indigo500,
      ...
      <GridItem
        ...
        style={{
          backgroundColor: magma.colors.indigo100,
          textAlign: 'center',
          padding: magma.spaceScale.spacing05,
      ...
      <GridItem
        ...
        style={{
          backgroundColor: magma.colors.indigo300,
          color: magma.colors.neutral0,
          textAlign: 'center',
          padding: magma.spaceScale.spacing05,
          width: isSmallerScreen ? 'calc(100% - 48px)' : 'auto',
      ...
      <GridItem
        ...
        style={{
          backgroundColor: magma.colors.indigo400,
          color: magma.colors.neutral0,
          textAlign: 'center',
          padding: magma.spaceScale.spacing05,
          width: isSmallerScreen ? 'calc(100% - 48px)' : 'auto',
    ...
    >
      <GridItem gridColumn="1 / 3">
        <AppBar
          ...
          onMenuButtonClick={() => setShowDrawer(true)}
          style={{
            backgroundColor: magma.colors.yellow400,
            color: magma.colors.neutral0,
          }}
        />
      </GridItem>
      ...
      <GridItem
        ...
        style={{
          textAlign: 'center',
          backgroundColor: magma.colors.yellow500,
          color: magma.colors.neutral0,
      ...
      <GridItem
        ...
        style={{
          textAlign: 'center',
          backgroundColor: magma.colors.yellow300,
          color: magma.colors.neutral0,
          padding: magma.spaceScale.spacing05,
    ...
    >
      {isLargeScreen ? (
        <Drawer position={DrawerPosition.left} isOpen={openDrawer}>
          <div
            style={{
              background: magma.colors.tangerine700,
              padding: magma.spaceScale.spacing05,
              width: '240px',
        ...
        <GridItem
          ...
          gridColumn="1 / 2"
          gridRow="1 / 3"
          style={{ background: magma.colors.tangerine700, width: '240px' }}
        >
          Sidebar
        </GridItem>
      )}
      ...
      <GridItem
        ...
        style={{
          ...
          width: '100%',
          justifySelf: 'center',
          background: magma.colors.tangerine500,
          padding: magma.spaceScale.spacing05,
          margin: '0 auto',
    ...
    >
      ...
      {isLargeScreen ? (
        <Drawer position={DrawerPosition.left} isOpen={openDrawer}>
          <div
            style={{
              background: magma.colors.indigo200,
              padding: magma.spaceScale.spacing05,
              width: '240px',
              height: 'calc(100vh - 32px)',
            }}
      ...
      <GridItem
        ...
        style={{
          ...
          width: '100%',
          justifySelf: 'center',
          background: magma.colors.indigo500,
          color: magma.colors.neutral0,
          padding: magma.spaceScale.spacing05,
          height: 'calc(100vh - 122px)',
        }}
      ...
      <GridItem
        ...
        style={{
          ...
          width: '100%',
          justifySelf: 'center',
          background: magma.colors.indigo700,
          color: magma.colors.neutral0,
          padding: magma.spaceScale.spacing05,
          height: '10vh',
        }}
