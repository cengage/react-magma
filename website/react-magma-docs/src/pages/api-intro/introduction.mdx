...
<LeadParagraph>
  Install the Magma component library, and start using Cengage-themed,
  accessible components in your application.
</LeadParagraph>

For more information, including information on contributing to Magma and running the project locally, visit the [Github Repo](https://github.com/cengage/react-magma).
...
Install the Magma component library with `npm`.
