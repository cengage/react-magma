...
export function IndexPageContent() {
  return (
    <StyledGrid gridTemplateRows="auto" gridGap={magma.spaceScale.spacing06}>
      <StyledGridItem gridColumn="1 / 3">
      ...
      <StyledGridItem>
        <Card background={magma.colors.neutral07}>
          <CardBody>
            ...
            <Button style={{ display: 'flex', marginTop: '2em' }}>
              Start Designing
            </Button>
          </CardBody>
        </Card>
      ...
      <StyledGridItem gridColumn="1 / 3" style={{ textAlign: 'center' }}>
        <Heading level={2}>Working smarter, not harder</Heading>
        <p>
          Standardized cmponents support collaboration, reinforce branding, and
          provide a consistent look and user experience.
        </p>
      </StyledGridItem>
      ...
      <StyledGridItem gridColumn="1 / 3" style={{ textAlign: 'center' }}>
        ...
        <p>
          We welcome all ideas and feedback to help us produce the best possible
          experience for our users. If you're interested in contributing, review
          our contribution guidelines to get started.
        </p>
        <Button style={{ margin: 'auto', maxWidth: 'fit-content' }}>
          Start Contributing
        </Button>
      </StyledGridItem>
    </StyledGrid>
